...
def go12():
    ...
    pricelogging.info("tx=%s,tddx=%s,5open=%s,5close=%s" % ((lastm1.open < lastm1.close and prelastm1.open < prelastm1.close),(lastM5.open>lastM5.close and lastM5.j < prelastM5.j),lastM5.open,lastM5.close) )
