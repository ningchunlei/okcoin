...
def go5():
    ...
    if buyPrice1==None and  prelast1diff > pre2last1diff and  pre2last1diff<0 and lastm1.macd >= prelastm1.macd:
        if stock1Min.touchDown() or (lastM5.j-lastM5.k>0):
            buy1Time = current.time
            buy2Time = lastM5.time
            buyPrice1 = current.close
            kk1pos = k1pos
    ...
    if buyPrice1!=None and prelast1diff < pre2last1diff and lastm1.macd <= prelastm1.macd and stock1Min.touchDown()==False:
