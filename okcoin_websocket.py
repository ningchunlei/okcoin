...
def go21():
            ...
            if prelastm2.mn["5"] < prelastm2.mn["10"]:
                if prelastm1.mn["5"] > prelastm1.mn["10"]:
                    if prelastm1.macd<0:
                        ...
                        return (43,stock1Min.checkvm(prelastm1.time),kkdata[1])
    ...
    if buyPrice1!=None:
        ...
        if lastm1.close < lastm1.mn["25"]:
            if lastm1.mn["5"] < lastm1.mn["10"]:
                sell(110)
                sellSpec = None
                spec = None
                up15 = None
                ...
                buyTriggerTime = None
                buyPrice3 = None
            elif lastm1.macd<prelastm1.macd and lastm1.close<prelastm1.close:
                sell(120)
                sellSpec = None
                spec = None
                up15 = None
...
def go22():
    ...
    if buyPrice1==None:
        ...
        if prelastm1.dif < 0 and lastm1.dif>=0:
            buy1Time = current.time
            buy2Time = lastM5.time
            buy(1)
