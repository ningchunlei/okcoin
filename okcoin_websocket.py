...
def go10():
    ...
    if buyPrice1==None:
        if sellSpec==True and lastM5.macd > prelastM5.macd+0.02 and lastM5.j > prelastM5.j+3:
...
def go11():
    ...
    if buyPrice1==None and prelastM5.j>pre2lastM5.j and prelastM5.j<20 and prelastM5.macd>pre2lastM5.macd:
        buy1Time = current.time
        buy2Time = lastM5.time
        buyPrice1 = current.open
        kk1pos = k1pos
