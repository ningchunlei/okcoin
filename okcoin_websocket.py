...
def go():
    ...
    if  lastM5.time - buy2Time > 5*60 and prelast5diff<=0:
        if buyPrice1!=None:
    ...
    if buyPrice1==None and buy2Time!=None and prelast1diff > pre2last1diff and  pre2last1diff<0 and prelast5diff>0 and lastM5.j-lastM5.k>0:
